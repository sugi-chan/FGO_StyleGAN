...
if 1:
    ...
    # Dataset.
    desc += '-face';     dataset = EasyDict(tfrecord_dir='face', resolution=512);              train.mirror_augment = True
    ...
    # Number of GPUs.
    desc += '-1gpu'; submit_config.num_gpus = 1; sched.minibatch_base = 4; sched.minibatch_dict = {4: 256, 8: 256, 16: 128, 32: 64, 64: 32, 128: 16, 256: 8}
